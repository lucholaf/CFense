...
#define SHKFacebookKey				@"fe9d2f4500468383f346c7487396169c"
#define SHKFacebookSecret			@"9f1f93e7788df949f5994bf57b34c5f8"
 ...
 */
#define SHKTwitterConsumerKey		@"2vislMhv29occsVLWPpGVw"
#define SHKTwitterSecret			@"1y8uI0ywdFdJtAirtq1FRFNa6oXIgkuXbjfP4NR5oA"
#define SHKTwitterCallbackUrl		@"http://www.quitarts.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
